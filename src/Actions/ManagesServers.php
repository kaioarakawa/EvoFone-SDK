...
use EvoFone\Resources\Event;
use EvoFone\Resources\PHPVersion;
use EvoFone\Resources\Server;
...
trait ManagesServers
{
     ...
     *
     * @return \EvoFone\Resources\Server[]
     */
    ...
    /**
     * Reconnect the server to FoneEvo with a new key.
     *
     * @param  string  $serverId
     * @return void
     */
     ...
     *
     * @param  int  $serverId
     * @return \EvoFone\Resources\PHPVersion[]
     */
     ...
     * @return \EvoFone\Resources\Event[]
     */
